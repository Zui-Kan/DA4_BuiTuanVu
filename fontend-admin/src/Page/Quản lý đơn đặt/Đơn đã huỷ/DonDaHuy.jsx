...
import {
  apiHienThiTrangThai_0,
  apiHienThiTrangThai_3,
} from "../../../services/DatHang.service";
import { formatPrice } from "../../../shares/format";
import ChiTietDonHuy from "./ChiTietDonHuy";
...
const DonDaHuy = () => {
  ...
  const loadData = async () => {
    setLoading(true);
    const results = await apiHienThiTrangThai_0({
      ...tableParams,
      search: valueSearch,
    });
