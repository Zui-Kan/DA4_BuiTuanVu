...
import { apiHienThiTrangThai_3 } from "../../../services/DatHang.service";
import { formatPrice } from "../../../shares/format";
import { apiGetNhanVienbyTK } from "../../../services/NhanVien.service";
import ConfirmNVGiaoXe from "./ConfirmNVGiaoXe";
...
const NVGiaoXe = () => {
  ...
  const loadData = async () => {
    ...
    if (getNV && getNV.status_code === 200) {
      const results = await apiHienThiTrangThai_3({
        ...tableParams,
        search: valueSearch,
