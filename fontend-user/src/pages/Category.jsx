...
function Category(props) {
  ...
  async function loadData(id, currentPage, filters = {}) {
    ...
    const [boLoc, hangxe, namSanXuat, nhienLieu] = await Promise.all([
    ...
    setData({ boLoc, hangxe, namSanXuat, nhienLieu });
  ...
  const handleHangXeChange = (event) => {
    const value = event.target.value;
    setSelectedHangXe((prev) =>
    ...
    <>
      <main>
        <div className="listCar">
          <div className="title-listCar">DÒNG XE → {data.boLoc.tenloaixe}</div>
          <hr />
          <div className="row">
            <div className="col-3">
              <div className="filters">
                ...
                >
                  ...
                  <div className="col-9 blueDark-c">Hãng xe</div>
                  <div className="col-1">
                    {showBrands ? (
                ...
                {showBrands && (
                  <div className="filter-brands">
                    {data?.hangxe?.data.map((item) => (
                      <div className="row filter-sub" key={item.MaHang}>
                        <div className="col-1">
                          <label className="custom-checkbox">
                            <input
                              ...
                              type="checkbox"
                              value={item.MaHang}
                              onChange={handleHangXeChange}
                            />
                            <span className="checkmark"></span>
                          </label>
                        </div>
                        <div className="col blueDark-c">{item.TenHang}</div>
                      </div>
                    ))}
                  </div>
                )}
